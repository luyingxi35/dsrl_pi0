"""CLI entry point for train_sim_dino_v2.py.

Key additions vs launch_train_sim_dino.py:
  --robofac_python  path to robofac Python (runs ManiSkill subprocess)
"""
import sys
...
from examples.train_sim_dino_v2 import main
from jaxrl2.utils.launch_util import parse_training_args


if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="DSRL sim training v2: ManiSkill subprocess + pi0_droid + StateSAC + DINOv2"
    )
