...
from examples.sim.train_dino_dense_pi05_delta import main
from jaxrl2.utils.launch_util import parse_training_args


if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="DSRL sim training pi0.5 dense-reward delta-action (pd_joint_delta_pos) (dense reward): ManiSkill + pi05_droid + StateSAC + DINOv2 + Robometer"
    )
